...
export const metadata = {
  title: "Dr. Harsha Gupta", // Set the title for this page
  description: "Digital Business Card of Dr. Harsha Gupta",
};
      ...
      <main className="relative mx-auto mt-8 flex max-w-[90%] flex-col items-center justify-center overflow-clip">
        ...
        <section>
          ...
          <div className="mx-auto">
            ...
            >
              <button className="w-[90vw] rounded-xl bg-red-300 p-3 text-base transition-all duration-300 hover:bg-red-500 hover:text-white active:bg-black-100 active:text-white md:w-[80vw] md:p-3 md:px-6 lg:w-[25vw]">
